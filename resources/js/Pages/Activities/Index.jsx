...
export default function ActivitiesIndex({ activities, users, filters, statuses, sources }) {
                        ...
                        <div className="space-y-4">
                            <div className="flex gap-4">
                                <div className="flex-1">
                                    <input
                                        type="text"
                                        placeholder="Search by name, due_date, priority, company, job title, notes, address, or city..."
                                ...
                                {activities.data.length === 0 ? (
                                    ...
                                    activities.data.map((activity) => (
                                        <tr key={activity.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td className="whitespace-nowrap px-6 py-4">
                                                <div className="text-sm text-gray-900 dark:text-white">{activity.due_date}</div>
                                                <div className="text-sm text-gray-500 dark:text-gray-400">{activity.priority}</div>
                                            </td>
                                            ...
                                            <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-900 dark:text-white">
                                                {activity.status ? `$${parseFloat(activity.status).toLocaleString()}` : '-'}
                                            </td>
