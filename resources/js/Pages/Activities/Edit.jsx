...
export default function Edit({ activity, users, statuses, sources }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        source: activity.source || 'website',
        ...
        last_contact_date: activity.last_contact_date ? activity.last_contact_date.split('T')[0] : '',
    });
    ...
    return (
        <AuthenticatedLayout header={`Edit Lead: ${activity.full_name}`}>
            <Head title={`Edit Lead - ${activity.full_name}`} />
