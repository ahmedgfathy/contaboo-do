...
export default function EditContact({ contact, types }) {
    ...
    const translations = {
        ...
        ar: {
            ...
            cancel: 'إلغاء',
            updateButton: 'تحديث جهة الاتصال',
        },
    };
    ...
    return (
        <AuthenticatedLayout header={t.editContact}>
            <Head title={t.editContact} />
            <div className="mx-auto max-w-7xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-end gap-4">
                        ...
                        <button type="submit" disabled={processing} className="rounded-lg bg-indigo-600 px-6 py-2 text-sm font-semibold text-white hover:bg-indigo-700 disabled:opacity-50">{t.updateButton}</button>
                    </div>
                </form>
            </div>
            <ScrollToTop />
