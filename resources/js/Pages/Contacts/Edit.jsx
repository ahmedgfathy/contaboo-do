...
export default function EditOpportunity({ contact, users, types, statuses, listing_types }) {
    const { data, setData, post, processing, errors } = useForm({
        title: contact.title || '',
        description: contact.description || '',
        type: contact.type || 'apartment',
        status: contact.status || 'available',
        listing_type: contact.listing_type || 'sale',
        price: contact.price || '',
        area: contact.area || '',
        bedrooms: contact.bedrooms || '',
        bathrooms: contact.bathrooms || '',
        parking_spaces: contact.parking_spaces || '',
        floor_number: contact.floor_number || '',
        total_floors: contact.total_floors || '',
        year_built: contact.year_built || '',
        furnished: contact.furnished || false,
        amenities: contact.amenities || [],
        contact_images: [],
        existing_images: contact.images || [],
    ...
    const removeNewImage = (index) => {
        const newImages = [...data.contact_images];
        newImages.splice(index, 1);
        setData('contact_images', newImages);
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    className="mt-1 w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                    placeholder="Detailed description of the contact..."
                                />
                    ...
                    <div className="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                {errors.contact_images && <p className="mt-1 text-sm text-red-600">{errors.contact_images}</p>}
                            </div>
