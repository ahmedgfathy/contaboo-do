            ...
            <div className="space-y-6">
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
                            <div className="border-b border-gray-200 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-900">
                                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t.personalInformation}</h3>
                            </div>
                            <div className="p-6">
                                <dl className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    ...
                                    <div>
                                        <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.jobTitle}</dt>
                                        <dd className="mt-1 text-sm text-gray-900 dark:text-white">{lead.job_title || t.na}</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>
                        ...
                        {(lead.requirements || lead.budget || lead.property_type || lead.property_category || lead.no_of_rooms || lead.no_of_bathrooms || lead.asking) && (
                            <div className="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
                                <div className="border-b border-gray-200 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-900">
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t.leadRequirements}</h3>
                                </div>
                                <div className="p-6">
                                    <dl className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                        {lead.requirements && (
                                            <div className="sm:col-span-2">
                                                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.requirements}</dt>
                                        ...
                                        {lead.property_type && (
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.propertyType}</dt>
                                                <dd className="mt-1 text-sm text-gray-900 dark:text-white">
                                        ...
                                        {lead.property_category && (
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.propertyCategory}</dt>
                                                <dd className="mt-1 text-sm text-gray-900 dark:text-white">
                                        ...
                                        {lead.no_of_rooms !== null && lead.no_of_rooms !== undefined && (
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.noOfRooms}</dt>
                                        ...
                                        {lead.no_of_bathrooms !== null && lead.no_of_bathrooms !== undefined && (
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.noOfBathrooms}</dt>
                                                <dd className="mt-1 text-sm text-gray-900 dark:text-white">{lead.no_of_bathrooms}</dd>
                                            </div>
                                        )}
                                        {lead.asking && (
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.asking}</dt>
                                                <dd className="mt-1 text-sm text-gray-900 dark:text-white">
                            ...
                            <div className="p-6">
                                <dl className="grid grid-cols-1 gap-6">
                                    <div>
                                        ...
                                        <dd className="mt-1 text-sm text-gray-900 dark:text-white">{lead.company || t.na}</dd>
                                    </div>
                                </dl>
                            </div>
                        </div>
                        ...
                        {(lead.address || lead.city || lead.state || lead.country) && (
                            <div className="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
                                <div className="border-b border-gray-200 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-900">
                                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t.address}</h3>
                                </div>
                                <div className="p-6">
                                    <dl className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                        {lead.address && (
                                            <div className="sm:col-span-2">
                                                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.streetAddress}</dt>
                                                <dd className="mt-1 text-sm text-gray-900 dark:text-white">{lead.address}</dd>
                                            </div>
                                        )}
                                        {lead.city && (
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.city}</dt>
                                                <dd className="mt-1 text-sm text-gray-900 dark:text-white">{lead.city}</dd>
                                            </div>
                                        )}
                                        {lead.state && (
                                            <div>
                                                <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.state}</dt>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
                            <div className="border-b border-gray-200 bg-gray-50 px-6 py-4 dark:border-gray-700 dark:bg-gray-900">
                                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{t.leadDetails}</h3>
                            </div>
                            <div className="p-6 space-y-4">
                                ...
                                <div>
                                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.source}</dt>
                                    <dd className="mt-1 text-sm text-gray-900 dark:text-white">
                                ...
                                <div>
                                    ...
                                    <dd className="mt-1 text-sm font-semibold text-gray-900 dark:text-white">
                                        {lead.estimated_value ? `$${parseFloat(lead.estimated_value).toLocaleString()}` : t.na}
                                    </dd>
                                </div>
                                <div>
                                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.assignedTo}</dt>
                                    <dd className="mt-1 text-sm text-gray-900 dark:text-white">
                                        {lead.assigned_to?.name || t.unassigned}
                                    </dd>
                                </div>
                                <div>
                                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.lastContact}</dt>
                                    <dd className="mt-1 text-sm text-gray-900 dark:text-white">
                                        {lead.last_contact_date ? formatDate(lead.last_contact_date) : t.na}
                                    </dd>
                                </div>
                                <div>
                                    <dt className="text-sm font-medium text-gray-500 dark:text-gray-400">{t.createdBy}</dt>
                        ...
                        <div className="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
                            ...
                            <div className="p-6 space-y-4">
                                ...
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                            {t.by} {lead.created_by?.name || 'Unknown'}
                                        </p>
                                ...
                                {lead.updated_at && lead.updated_at !== lead.created_at && (
                                    <div className="flex items-start space-x-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                                                {t.by} {lead.updated_by?.name || 'Unknown'}
                                            </p>
                                            <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">
                                ...
                                <div className="pt-3 border-t border-gray-200 dark:border-gray-700">
                                    ...
                                    >
                                        <svg className={`h-4 w-4 ${locale === 'ar' ? 'ml-1.5' : 'mr-1.5'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
