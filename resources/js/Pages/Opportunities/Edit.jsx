...
export default function EditOpportunity({ opportunity, users, types, statuses, listing_types }) {
    const { data, setData, post, processing, errors } = useForm({
        title: opportunity.title || '',
        description: opportunity.description || '',
        type: opportunity.type || 'apartment',
        status: opportunity.status || 'available',
        listing_type: opportunity.listing_type || 'sale',
        price: opportunity.price || '',
        area: opportunity.area || '',
        bedrooms: opportunity.bedrooms || '',
        bathrooms: opportunity.bathrooms || '',
        parking_spaces: opportunity.parking_spaces || '',
        floor_number: opportunity.floor_number || '',
        total_floors: opportunity.total_floors || '',
        year_built: opportunity.year_built || '',
        furnished: opportunity.furnished || false,
        amenities: opportunity.amenities || [],
        opportunity_images: [],
        existing_images: opportunity.images || [],
    ...
    const handleImageChange = (e) => {
        ...
        setData('opportunity_images', files);
    ...
    const removeNewImage = (index) => {
        const newImages = [...data.opportunity_images];
        newImages.splice(index, 1);
        setData('opportunity_images', newImages);
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('opportunities.update', opportunity.id), {
            forceFormData: true,
        });
    };
                    ...
                    <div className="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                {errors.opportunity_images && <p className="mt-1 text-sm text-red-600">{errors.opportunity_images}</p>}
                            </div>
