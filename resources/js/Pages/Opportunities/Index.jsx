...
export default function OpportunitiesIndex({ opportunities, users, filters, stages, statuses, types, stats, savedFilters = [], availableColumns = [] }) {
    ...
    const handleApplyFilter = (filter) => {
        ...
        // Apply filter conditions to searchForm
        ...
        router.get(route('opportunities.index'), newData, {
            preserveState: true,
            preserveScroll: true,
        });
    };
